...
class Update extends Component
{
    ...
    {
        $this->status = $this->catatan->status;
        $this->type = $this->catatan->type;
        $this->categories = $this->catatan->categories;
        $this->tags = $this->catatan->tags;
        $this->tanggal = $this->catatan->tanggal;
        $this->target = $this->catatan->target;
        $this->collected = $this->catatan->collected;
    }

    public function render(): View
    {

        return view('livewire.catatan.update',);
    }
