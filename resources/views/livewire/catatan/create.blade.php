<div>
    ...
    <x-modal :title="__('Buat Catatan Baru')" wire x-on:open="setTimeout(() => $refs.title.focus(), 250)">
        <form id="catatan-create" wire:submit="save" class="space-y-4">
            <div>
        ...
        <x-slot:footer>
            <x-button type="submit" form="catatan-create">
                Save
            </x-button>
        </x-slot:footer>
    </x-modal>
